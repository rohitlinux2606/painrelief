    ...
    <div class="container my-5">
        <div class="row g-5">
            ...
            <div class="col-md-5">
                ...
                <a href="{{ $product->external_link ? $product->external_link : route('add-to-cart', $product->id) }}" class="btn-add-to-cart" onclick="addToCartEvent()">Add to
                    cart</a>

                <a href="{{ $product->external_link ? $product->external_link : route('buy-now', $product->id) }}" class="btn-buy-now" onclick="buyNowEvent()">
                    <span>BUY NOW</span>
